...
//       // Need to show upload dialog here
//       this.api.postApi(`createAssignment?roomId=${this.roomId}`, formData).subscribe((result: any) => {
//         if (!result.error) {
//             localStorage.setItem('assignmentId', result.assignment._id);
//             this.assignment_status = true;
...
//       if (data !== '') {
//         // console.warn('Call Component :', data);
//         this.checkSS = data;
...
//     this.students = e;
//     console.log('nitin', this.students)
//   }
...
//     this.ss.socket.emit('publish-assignment', {id: localStorage.getItem('assignmentId'), roomId: this.roomId});
//     localStorage.removeItem('assignmentId');
//     this.assignment_status = false;
//   }
